...
const StridesPerMinute = ({ stridesPerMinuteData, TitleComponent, title }) => {
  // console.log("asdfasdf");
  // console.log(strideLengthData);
  // Calculate min/max with a buffer
  const values = stridesPerMinuteData.map((d) => d.y);
...
export default StridesPerMinute;
